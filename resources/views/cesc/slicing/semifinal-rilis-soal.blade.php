    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-lg-6 col-12 mb-2">
                ...
                <div class="mt-lg-2 mt-1 mb-0 bd-highlight title">Rilis <span class="bold-blue">Soal Semifinal</div>
                <div class="mb-0 bd-highligt sub-title">download soal pada url berikut:</div>
                <a href="submission-final">
                    <button type="button" class="btn btn-daftar w-100">
                        <img src="{{ asset('civex/img/icon/icon-paper.svg') }}" alt="your_image" width="20"
                            height="20">
