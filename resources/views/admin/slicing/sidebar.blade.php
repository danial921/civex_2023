    ...
    <div class="off-canvas-body pd-t-5 pd-md-t-10">
        <ul class="sidebar-nav">
            ...
            <div class="collapse mg-l-35" id="collapse-gec">
                ...
                <li class="nav-item"><a href="{{url('/admin/gec-aanwijizing')}}" class="nav-link-its tx-poppins tx-medium text-truncate"></span>data aanwijizing</a></li>
            </div>
            ...
            <div class="collapse mg-l-35" id="collapse-cpcc">
                ...
                <li class="nav-item"><a href="{{url('/admin/cppc-aanwijizing')}}" class="nav-link-its tx-poppins tx-medium text-truncate"></span>data aawijizing</a></li>
            </div>
