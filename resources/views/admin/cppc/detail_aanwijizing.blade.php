                ...
                <div class="row">
                    <div class="col-12 mb-lg-3 mb-1">
                        ...
                        <input type="text" readonly disabled class="form-control" id="staticEmail"
                            value="Asline disini judul pertanyaan cman aku gatau getnya dmn">
                    </div>
                    <div class="col-12 mb-lg-3 mb-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-civex tx-poppins tx-medium" id="btnSubmit2" onclick="location.href='/admin/cppc-aanwijizing'">Ya, Saya Yakin</button>
            </div>
        </div>
    </div>
</div>
