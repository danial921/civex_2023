<div class="card mb-2">
    <div class="card-body">
        <div class="title">Daftar Peserta Workshop</div>
            ...
            <table id="myTable" class="table table-hover table-borderless" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="text-center wd-25">Instansi</th>
                        <th class="text-center wd-5p">Menu</th>
                        <th class="text-center wd-15p">Created at</th>
                        <th class="text-center wd-15p">Updated at</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($teams as $team)
                        <tr class="bd-b">
                            <td>
                                <p class="mg-b-0">{{ $team->nama }}</p>
                            </td>
                            <td>
                                <p class="mg-b-0">{{ $team->instansi }}</p>
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    <a href="\admin\detailpendaftar-workshop\{{ $team->id }}" class="btn btn-icon pd-0">
