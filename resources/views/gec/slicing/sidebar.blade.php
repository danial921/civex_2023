<div id="menu-sidebar" class="off-canvas off-canvas-overlay wd-300 wd-md-400 shadow">
    ...
    <div class="off-canvas-body pd-t-5 pd-md-t-10">
        <ul class="sidebar-nav">
            <li class="nav-item d-flex justify-content-between align-items-center"><a href="{{url('/gec')}}" class="nav-link-its tx-poppins tx-medium text-truncate flex-grow-1"><img src="{{ asset('civex/img/icon/competition.png') }}" class="wd-20 mg-r-15">Geotechnical Engineering
            ...
            <div class="collapse mg-l-35" id="collapse-menu-kelola-1">
                <li class="nav-item"><a href="{{url('/gec/pembagian-soal')}}" class="nav-link-its tx-poppins tx-medium text-truncate">Pembagian Soal</a></li>
                ...
                <li class="nav-item"><a href="{{url('/gec/submission-final')}}" class="nav-link-its tx-poppins tx-medium text-truncate"></span> Pengungpulan Kebutuhan Final</a></li>
            </div>
