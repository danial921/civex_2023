        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6 col-12">
                        ...
                        <label for="exampleFormControlInput1 formtitle" class="form-pendaftaran">Dosen Pembimbing</label>
                        <input type="email" class="form-control" id="exampleFormControlInput1"
            ...
            <label for="exampleFormControlInput1 formtitle" class="form-pendaftaran">Upload SK Mahasiswa Aktif, Scan KTM Ketua dan Anggota (Dalam 1 berkas PDF)</label>
            <div class="row">
                <div class="col-lg-6 col-12">
