    ...
    <div class="container pt-5 mt-5">
                    ...
                    <div class="col-6">
                        <div class="d-flex bd-highlight mb-3 justify-content-center">
                            ...
                            <div class="p-2 bd-highlight">
                                ...
                                <p class="mg-b-1 ">Rp.150.000,00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="d-flex bd-highlight mb-3 justify-content-center">
                            ...
                            <div class="p-2 bd-highlight">
                                ...
                                <p class="mg-b-1 ">Rp.180.000,00</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1 formtitle" class="form-pendaftaran">Nomer</label>
                ...
                <div class="mb-3">
                    ...
                    <p class="image-sub-label">pembayaran dapat dilakukan pada nomer rekening <span
                            class="c-cpcc">12345678991 (BCA)</span> Sebesar <span class="c-cpcc">{{ $biaya_daftar }}</span></p>
