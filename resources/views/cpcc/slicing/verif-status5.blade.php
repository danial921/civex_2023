            ...
            <div class="col-lg-7 col-12">
                <div class="d-flex bd-highlight mb-2 justify-content-start">
                    ...
                    <div class=" bd-highlight">
                        ...
                        <p class="mb-0 danger text-center">Berkas pendaftaran ditolak, silahkan mengisi ulang berkas pendaftarann</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-12">
                <p class="form mb-1 w-100">Lengkapi Berkas Pendaftaran Disini</p>
                <a href="/cppc/formulir-tim"">
