            ...
            <div class="col-lg-6 col-12">
                <div class="d-flex bd-highlight mb-2 justify-content-start">
                    ...
                    <div class=" bd-highlight">
                        ...
                        <p class="mg-b-1 success text-center">Tim Sudah  melengkapi berkas pendaftaran</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="d-flex bd-highlight mb-2 justify-content-start">
                    ...
                    <div class=" bd-highlight">
                        ...
                        <p class="mg-b-1 success text-center">Tim sudah Mengunggah Proposal</p>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <p class="form mb-2">akses guidebook dan template laporan dapat di akses pada link berikut
                </p>
            </div>
            <div class="col-lg-6 col-12 mb-lg-0 mb-2">
                <a href="{{ ENV('GUIDEBOOK_CPPC') }}">
