        ...
        <ul class="sidebar-nav">
            ...
            <div class="collapse mg-l-35" id="collapse-menu-kelola-1">
                ...
                @if(strtotime(date("Y-m-d H:i:s")) >= strtotime('2023-10-8 23:59:59'))
                    ...
                    <li class="nav-item"><a href="{{url('/cppc/aanwijizing')}}" class="nav-link-its tx-poppins tx-medium text-truncate"></span>Aanwijzing</a></li>
                @else
                ...
                @if(strtotime(date("Y-m-d H:i:s")) >= strtotime('2023-10-8 23:59:59') && $status === '3')
                ...
                @elseif($status === '3')
                    <li class="nav-item"><a class="nav-link-its tx-poppins tx-medium text-truncate"></span> Pengungpulan Kebutuhan Final</a></li>
                @endif
            </div>
