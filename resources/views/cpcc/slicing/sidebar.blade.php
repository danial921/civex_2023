        ...
        <ul class="sidebar-nav">
            ...
            <div class="collapse mg-l-35" id="collapse-menu-kelola-1">
                @if(strtotime(date("Y-m-d H:i:s")) >= strtotime('2023-10-8 23:59:59'))
                    <li class="nav-item"><a href="{{url('/cpcc/soal')}}" class="nav-link-its tx-poppins tx-medium text-truncate">Pembagian Soal</a></li>
                    <li class="nav-item"><a href="{{url('/cpcc/aanwijizing')}}" class="nav-link-its tx-poppins tx-medium text-truncate"></span>Aanwijzing</a></li>
                    <li class="nav-item"><a href="{{url('/cpcc/submission')}}" class="nav-link-its tx-poppins tx-medium text-truncate"></span> Submission</a></li>
                    <li class="nav-item"><a href="{{url('/cpcc/submission-final')}}" class="nav-link-its tx-poppins tx-medium text-truncate"></span> Pengungpulan Kebutuhan Final</a></li>
                @endif
            </div>
