<div class="card mg-b-20">
    <div class="card-body verifikasi">
        <p class="title mb-lg-2 mb-1">Status</p>
        <div class="row">
            <div class="col-lg-6 col-12">
                <div class="d-flex bd-highlight mb-2 justify-content-start">
                    ...
                    <div class=" bd-highlight">
                        ...
                        <p class="mb-0 danger text-center">Tim belum Mengajukan Pertanyaan</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="d-flex bd-highlight mb-3 justify-content-start">
                    ...
                    <div class=" bd-highlight">
                        ...
                        <p class="mb-0 danger text-center">Belum Mengajukan Pertanyaan</p>
                    </div>
                </div>
            </div>
        </div>
