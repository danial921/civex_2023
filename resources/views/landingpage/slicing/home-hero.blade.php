<div class="container container-home">
    ...
    <div class="row title-home">
        <div class="col-lg-6 col-12">
            <div class="title" data-entrance="from-bottom">Civil Expo ITS 2023</div>
            <div class="sub-title mt-lg-4 mt-3" data-entrance="fade">“From Civil Engineer to Civilization”</div>
            <button class="button mt-lg-4 mt-3" data-entrance="fade"><p>Explore More</p></button>
        </div>
    </div>
</div>
