<nav class="mb-4 navbar navbar-expand-lg navbar-light navbar-closing cyan fixed-top">
    <a class="navbar-brand font-bold" href="/">
        <img class="nav-icon" src="{{ asset('civex/img/icon/icon-civex-white.svg') }}" alt="">
    </a>
...
<script>
    window.addEventListener('scroll', function () {
        var navbar = document.querySelector('.navbar-closing');
        if (window.scrollY > 0) {
