<div class="card mt-2">
    <form id="form1" class="row m-4 pr-4" method="post" action="{{ route('register-workshop') }}" enctype="multipart/form-data">
        @csrf
        <input type="text" id="bundle" name="bundle" hidden value="1">
        ...
        <div class="col-12 mb-0 mb-lg-2 mb-1 mt-2">
            ...
            <input type="text" class="form-control" id="instansi.0-form1" name="instansi[]" required autofocus>
            <div class="invalid-feedback" id="instansi.0-false-form1"></div>
        </div>
        <div class="col-lg-6 col-12 mb-0 mb-lg-2 mb-1 mt-2">
            <label for="email" class="form-pendaftaran">Email</label>
            <input type="email" class="form-control" id="email.0-form1" name="email[]" required autofocus>
            <div class="invalid-feedback" id="email.0-false-form1"></div>
        </div>
        <div class="col-lg-6 col-12 mb-0 mb-lg-2 mb-1 mt-2">
            <label for="notelp" class="form-pendaftaran">Nomor Telefon</label>
            <input type="text" class="form-control" id="notelp.0-form1" name="notelp[]" required autofocus>
            <div class="invalid-feedback" id="notelp.0-false-form1"></div>
        </div>
        <div class="col-12 mb-0 mb-lg-2 mb-1 mt-2">
            ...
            <div class="fileupload-opening">
                <label for="fileField-form1" class="attachment w-100">
                    <div class="w-100 row btn-file">
                        <div class="w-100 btn-file__preview" id="file_preview-fileFieldform1"></div>
                        <div class="w-100 btn-file__actions">
                            <div class="w-100 btn-file__actions__item col-xs-12 text-center" id="actions_item-fileFieldform1">
                    ...
                    <input name="bukti_bayar" type="file" id="fileField-form1" data-id="fileFieldform1" style="display: none"
                        accept="image/jpeg, image/png" required>
                    <div class="alert alert-danger" id="bukti_bayar-false-form1" hidden></div>
                </label>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end align-items-center w-100">
            <input type="button" value="submit" class="btn btn-civex  mg-b-20 mg-r-20" id="btnSubmit"
                data-toggle="modal" data-animation="effect-scale" data-target="#simpan-form1">
        </div>
...
<!-- Modal simpan -->
<div class="modal fade effect-scale" id="simpan-form1" tabindex="-1" role="dialog" aria-labelledby="simpan"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button href="#" class="btn btn-civex tx-poppins tx-medium" onclick="submitForm('form1')"
                    id="btnSubmit2-form1">Ya, Saya Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal success -->
<div class="modal fade effect-scale" id="successModal-form1" tabindex="-1" role="dialog" aria-labelledby="successLabel"
    aria-hidden="true">
