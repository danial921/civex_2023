<div class="merch-katalog p-lg-5 p-2 pl-lg-5 pl-4 pr-lg-5 pr-4">

        <h1 class="mt-lg-3 mt-2">Silahkan Pilih Kategori :</h1>
        <div class="mt-4 pb-lg-3 m-lg-3 m-0">
            <div class="row">
                <div class="p-0 pr-lg-3 pr-0 col-md-2 col-12 d-flex flex-lg-column justify-content-center flex-wrap buttonnya">
                ...
                <div class="col-md-10 col-12 p-3 mt-lg-0 mt-3 pl-lg-5 pl-4" id="gallery">
                    ...
                    <div id="sticker" class="gallery-category ">
                        <div class="row mt-3">
                            <div class="col-lg-4 col-12 sticker">
                                <div class="item-card">
                                    <div class="image bg-balck align-item-center">
