...
<div class="container container-about-detail">
    ...
    <p class="desc pt-4"><span>Civil Expo ITS 2023</span> is a series of <span>national
...
<div id="openGroup" class="ourthem" style="display: show">
    <div class="row">
        ...
        <div class="col-lg-6 col-12 contianer-image">
            <img class="run mt-4 w-50" src="{{ asset('civex/img/icon/details-run.png') }}" alt="">
        </div>
    </div>
</div>
...
<div id="closeGroup" class="ourthem" style="display: none;">
    ...
    <div class="row mb-lg-4">
        ...
        <div class="col-lg-6 col-12 contianer-image">
            <img class="run mt-lg-2 mt-4 w-50 mb-5" src="{{ asset('civex/img/icon/details-run.png') }}" alt="">
        </div>
    </div>
    <div class="container ">
