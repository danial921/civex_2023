<div class="webinar-hero" id="webinar-hero">
    <div class="row">
        <div class="col-3 left-col d-lg-block d-none" style="background-image: url({{ asset('civex/img/icon/webinar-hero1.svg') }})"></div>
        <div class="col-lg-9 col-12 webinar-title">
...
<div class="breakline" style="background-image: url({{ asset('civex/img/icon/breakline_civex23.svg') }})">
</div>
