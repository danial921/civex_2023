    ...
    <div class="container">
        ...
        <div id="container">
            <div id="slider-container">
              <span onclick="slideRight()" style="box-shadow: none;" class="btn"><img src="{{ asset('civex/img/landingpage/galeri-icon-prev.svg') }}" alt=""></span>
                <div id="slider">
              ...
              <span onclick="slideLeft()" style="box-shadow: none;" class="btn"><img src="{{ asset('civex/img/landingpage/galeri-icon-next.svg') }}" alt=""></span>
            </div>
          </div>
    </div>
</div>
