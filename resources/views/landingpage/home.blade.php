...
<body class="hm-gradient landing-page">
    ...
    <main>
        ...
        <!--MDB Navbars-->
        @include('landingpage.slicing.home-hero')
        @include('landingpage.slicing.home-detail')
        @include('landingpage.slicing.home-activity')
        @include('landingpage.slicing.home-galery')
        @include('landingpage.slicing.home-sponsor')
    ...
    <script src="../../js/scrollanimete.js"></script>
